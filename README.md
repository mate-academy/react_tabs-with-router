...
[alternativeLink](https://reactrouter.com/en/main/components/navigate) - please see for yourselves, as the link provided opened a 404 for me, and here I found the page
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://UmizDemud.github.io/react_tabs-with-router/) and add it to the PR description.
