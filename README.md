...
1. `Tabs` page should work for both `/tabs` and `/tabs/:tabId` paths (use nested routes);
    ```tsx
    <Route path="tabs">
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://maksym-mishchanchuk.github.io/react_tabs-with-router/) and add it to the PR description.
