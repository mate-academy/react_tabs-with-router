...
The `Tabs` page should also show a `Tabs` component implemented in [React Tabs](/).
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://<Grayfox147.github.io/react_tabs-with-router/) and add it to the PR description.
