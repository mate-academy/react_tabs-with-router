...
- Replace `<your_account>` with your Github username in the
  [DEMO LINK](https://kiramarks.github.io/react_tabs-with-router/)
...
1. Add 2 pages `HomePage` and `Tabs`.
    - `HomePage` is shown on `localhost:3000` and contains a header `HomePage`.
